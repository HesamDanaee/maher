...
const Customers = () => {
  ...
  return (
    <div className="w-full h-full grid grid-cols-12 grid-rows-6">
      ...
      <div className="grid grid-cols-12 grid-rows-6 col-start-4 col-end-10 row-start-2 row-end-6 max-2xl:col-start-2 max-2xl:col-end-12">
        <div className="flex max-sm:flex-col gap-y-4 justify-between items-center col-start-1 col-end-13 row-start-1 row-end-2">
